...
import com.learnsphere.user.service.FileStorageService;
import com.learnsphere.user.service.JwtService;
import com.learnsphere.user.service.UserService;

@RestController
@RequestMapping("/api")
// CORS handled by API Gateway - no need for @CrossOrigin here
public class UserController {
    ...
    public ResponseEntity<?> getUserById(@PathVariable String id) {
        try {
            ...
            // Fallback: return just username for backward compatibility
            try {
    ...
    public ResponseEntity<?> register(@RequestBody User user) {
        try {
            ...
            String token = jwtService.generateToken(registeredUser.getUsername(), registeredUser.getId());
            Map<String, Object> response = new HashMap<>();
