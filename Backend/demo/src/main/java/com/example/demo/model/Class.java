...
public class Class {
    ...
    private Boolean isLive = false; // Whether meeting is currently active
    private String meetingRoomId; // Connective room ID
    private java.util.Date meetingStartedAt; // When the meeting was started
    private String meetingStartedBy; // Teacher ID who started the meeting
